...
public static boolean containsAlphabet(String txt) {
    ...
    if (txt.matches(".*[a-öA-Ö]+.*")) {
        ...
        JOptionPane.showMessageDialog(null, "Du har fält som innehåller enbart siffror istället för tecken eller en kombination av bägge. Kontrollera ifall du har ett namnfält eller epostfält att inmatning är korrekt");
    }
